        ...
        if (cod == 1) {
            ...
            setTimeout(function () {
                if (lg == 1) {
                    ...
                    font.innerHTML = 'a web deveeweeloper';
                }

                img.src = 'Portifolio V1/imagens/svg/svg2.svg';
            }, 1500);
            setTimeout(function () {
            ...
            setTimeout(function () {
                ...
                img.src = 'Portifolio V1/imagens/svg/svg4.svg';
            }, 1500);
            setTimeout(function () {
                font.style.opacity = '1';
                img.style.marginTop = '0';
            ...
            setTimeout(function () {
                ...
                img.src = 'Portifolio V1/imagens/svg/svg1.svg';
            }, 1500);
            setTimeout(function () {
                font.style.opacity = '1';
                img.style.marginTop = '0';
...
function DarkMode() {
    if (dark == 'off') {
        ...
        //document.getElementById('id-contact').style.backgroundImage = 'url(Portifolio V1/imagens/footer/footer_light.png)';
        document.getElementById('id-contact').style.backgroundImage = 'none';
        //document.getElementById('id-contact').style.backgroundColor = 'red';
        ...
        document.getElementById('img-html').src = 'Portifolio V1/imagens/icons/html_black.png';
        document.getElementById('img-css').src = 'Portifolio V1/imagens/icons/css_black.png';
        document.getElementById('img-js').src = 'Portifolio V1/imagens/icons/javascript_black.png';
        document.getElementById('img-pg').src = 'Portifolio V1/imagens/icons/postgres_black.png';
        document.getElementById('img-ps').src = 'Portifolio V1/imagens/icons/photoshop_black.png';
        document.getElementById('img-il').src = 'Portifolio V1/imagens/icons/illustrator_black.png';
        document.getElementById('img-git').src = 'Portifolio V1/imagens/icons/git_black.png';
        ...
        document.getElementById('id-contact').style.backgroundImage = 'url(Portifolio V1/imagens/footer/footer_dark.png)';
        ...
        document.getElementById('img-html').src = 'Portifolio V1/imagens/icons/html_white.png';
        document.getElementById('img-css').src = 'Portifolio V1/imagens/icons/css_white.png';
        document.getElementById('img-js').src = 'Portifolio V1/imagens/icons/javascript_white.png';
        document.getElementById('img-pg').src = 'Portifolio V1/imagens/icons/postgres_white.png';
        document.getElementById('img-ps').src = 'Portifolio V1/imagens/icons/photoshop_white.png';
        document.getElementById('img-il').src = 'Portifolio V1/imagens/icons/illustrator_white.png';
        document.getElementById('img-git').src = 'Portifolio V1/imagens/icons/git_white.png';
...
function MouseImg(cod) {
    ...
    while (i <= 5) {
        document.getElementById('img' + i).src = 'Portifolio V1/imagens/slides/projeto' + i + _name;
        i++;
    }
}

function ViewProject(cod) {
    if (cod == 1) window.open('https://inanbruneli.github.io/Parallax/', '_blank');
    else if (cod == 2) window.open('https://inanbruneli.github.io/CardPrecos/', '_blank');
    else if (cod == 3) window.open('https://inanbruneli.github.io/RangeHotels/', '_blank');
    else if (cod == 4) window.open('https://inanbruneli.github.io/Backpack/', '_blank');
    else if (cod == 5) window.open('https://inanbruneli.github.io/Strata', '_blank');
}
...
function downloadResume() {
    if (lg == 1) {
        window.open('Portifolio V1/files/Inan Brunelli Brandao-pt.pdf');
    }
    else {
        window.open('Portifolio V1/files/Inan Brunelli Brandao-en.pdf');
    }
...
function btnSubmit() {
    ...
    $.ajax({
        type: "GET",
        cache: false,
        url: "http://8light.ddns.net/8LIGHT/api_goauditt/index.php/cc/",
        timeout: 3000,
        ...
        error: function (request, error) {
            alert("Erro permissao_edicao_search");
        },
